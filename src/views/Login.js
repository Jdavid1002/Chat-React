            ...
            <div className="row shadow-lg" >
                <div className="col-md-4" >
                    <div className="p-4" > 
                        ...
                        <div>
                            <hr />
                            <p> You do not have an account?<span className="pointer text-green" onClick={()=> window.location.replace("/Chat-React/#/Register") } > Sign Up </span> </p>
                        </div>
                    </div>
                </div>
                <div className="col-md-8 bg-green" >
                </div>
            </div>
        </div>
    );
